    ...
    public sealed class StateMachineTests
    {
        ...
        public IEnumerator SetState_RaisesEventsInOrder()
        {
            return UniTask.ToCoroutine(async () =>
            {
                ...
                _stateMachine.OnStateChangeRequested += (_, _,_) => events.Add("Requested");
                _stateMachine.OnStateUnloadFinished += (_, _) => events.Add("Exited");
                _stateMachine.OnStateLoadFinished += (_, _) => events.Add("Entered");
        ...
        public IEnumerator SetState_Null_DoesNotRaiseEntered()
        {
            return UniTask.ToCoroutine(async () =>
            {
                ...
                _stateMachine.OnStateLoadFinished += (_, _) => enteredCount++;
