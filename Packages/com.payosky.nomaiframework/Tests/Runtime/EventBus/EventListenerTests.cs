...
namespace NomaiFramework.Tests.EventBus
{
    public class EventListenerTests
    {
        ...
        [Test]
        public void Register_SubscribesListenerToEventBusService()
        {
        ...
        [Test]
        public void Register_ReturnsSameListener()
        {
            ServiceLocator.AddService(new EventBusService());
        ...
        [Test]
        public void Register_WhenCalledMultipleTimes_DoesNotSubscribeMultipleTimes()
        {
            EventBusService eventBus = new();
        ...
        [Test]
        public void Unregister_UnsubscribesListenerFromEventBusService()
        {
            EventBusService eventBus = new();
        ...
        [Test]
        public void Unregister_ReturnsSameListener()
        {
            ServiceLocator.AddService(new EventBusService());
        ...
        [Test]
        public void Register_AfterUnregister_SubscribesAgain()
        {
            EventBusService eventBus = new();
