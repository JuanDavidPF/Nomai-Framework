...
namespace NomaiFramework.Tests.Services
{
    ...
    public class ServiceLoaderTests
    {
        ...
        [Test]
        public void AddServices_LoadsServices()
        {
            TestService service = new();
            AnotherTestService anotherService = new();
        ...
        [Test]
        public void RemoveServices_RemovesServices()
        {
            TestService service = new();
            AnotherTestService anotherService = new();
        ...
        [Test]
        public void RemoveServices_DisposesServices()
        {
            TestService service = new();
            AnotherTestService anotherService = new();
        ...
        [Test]
        public void OnDestroy_WithOnDestroyHook_RemovesServices()
        {
            TestService service = new();
    ...
    public class ServiceBundleLoaderTests
    {
        ...
        public void TearDown()
        {
            ...
            UnityEngine.Object.DestroyImmediate(_serviceBundle);
            UnityEngine.Object.DestroyImmediate(_gameObject);
        }

        [Test]
        public void AddServices_RegistersBundleServices()
        {
            TestService service = new();
            AnotherTestService anotherService = new();
        ...
        [Test]
        public void AddServices_LoadsBundleServices()
        {
            TestService service = new();
            AnotherTestService anotherService = new();
        ...
        [Test]
        public void RemoveServices_RemovesBundleServices()
        {
            TestService service = new();
            AnotherTestService anotherService = new();
        ...
        [Test]
        public void RemoveServices_DisposesBundleServices()
        {
            TestService service = new();
            AnotherTestService anotherService = new();
        ...
        [Test]
        public void OnDestroy_WithOnDestroyHook_RemovesBundleServices()
        {
            TestService service = new();
